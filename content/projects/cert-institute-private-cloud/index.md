...
|---|---|
| 발주처 | 국가 시험인증기관 |
| 기간 | 2025.04 ~ 2025.11 (설계 착수 2025.05 · 구축 완료 2025.09 · 운영자 교육·시스템 전환·시범 운영 2025.09 ~ 10 · 안정화 ~ 2025.11) |
...
기존에 물리 서버로 흩어져 있던 기관의 업무시스템을 한 클러스터 위로 모으는 사업입니다. 설계 단계부터 참여해 아키텍처정의서와 시스템구축결과서를 직접 작성했고, 실제 구축과 업무시스템 이관, 운영자 교육, 시스템 전환·시범 운영, 인수인계까지 수행했습니다.
